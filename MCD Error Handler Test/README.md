Source code of the test ROMs included in this repo. Conditionals at the start of "MCD Error Handler Test.asm" and "Sub CPU Program.asm" are used to set which exceptions to test.
